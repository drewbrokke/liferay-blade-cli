...
public class ResourceUtil {
	...
	public static Resolver getURIResolver(File cacheDir, URI uri, String targetFileName) {
		return () -> {
			...
			try {
				Path path = downloadFile(url.toString(), cacheDir.toPath(), targetFileName);

				return return Files.newInputStream(path);
			}
	...
	private static Path downloadFile(String urlString, Path cacheDirPath, String targetFileName) throws Exception {
